      ...
      <div id="content">
            ...
            <div class="container px-3">
              <div class="row">
                <div class="col-lg-6 p-2">
                  <img
                    class="img-fluid"
                    src="images/illustrations/flowers-2058090_1920.png"
                    alt="hello"
                  />
                </div>
                <div class="col-lg-6">
                      ...
                      <nav role="navigation">
                        <ul class="nav justify-content-left">
                          <li class="nav-item">
                            <a
                              class="nav-link"
                              href="https://twitter.com/Sjay__1?s=08"
                              title="Twitter"
                          ...
                          <li class="nav-item">
                            <a
                              class="nav-link"
                              href="https://web.facebook.com/silas.joy.77/"
                              title="Facebook"
                          ...
                          <li class="nav-item">
                            <a
                              class="nav-link"
                              href="https://www.linkedin.com/in/joy-silas-77996b209/"
                              title="LinkedIn"
        ...
        <div class="section pt-4 px-3 px-lg-4" id="about">
          <div class="container-narrow">
            <div class="row">
              <div class="col-md-6">
                <h2 class="h4 my-2">Hello! I’m Joy Silas.</h2>
                <p>
                  Hi, I am currently a cybersecurity student undergraduate
                  studying in the Federal University of Technology Akure. I am a
                  creative and enthusiastic fullstack developer with a zeal to
                  learn and build new things. I develop websites using HTML,
                  CSS, Bootstrap, Javascript, Ajax, PHP and MySql database.
                </p>
                <div class="row mt-3">
                  <div class="col-sm-2">
                  ...
                  <div class="col-sm-10">
                    <div class="pb-1 fw-bolder">silasjoy22@gmail.com</div>
                  </div>
                  <div class="col-sm-2">
                    <div class="pb-1">LinkedIn:</div>
                  </div>
                  <div class="col-sm-10">
                    <div class="pb-1 fw-bolder">Joy Silas</div>
                  </div>
                  <div class="col-sm-2">
                    <div class="pb-1">Phone:</div>
                  </div>
                  <div class="col-sm-10">
                    <div class="pb-1 fw-bolder">+234 703 604 4505</div>
                  </div>
                  <div class="col-sm-2">
          ...
          <div class="container-narrow">
            ...
            <div class="text-center">
              <p class="mx-auto mb-3" style="max-width: 600px">
                I offer web development services that are tailored to meet your
                business needs and requirements. I can maximize timely
            ...
            <div class="row py-3">
              ...
              >
                <img
                  class="mb-2"
                  src="images/services/frontend.png"
                  width="96"
                  height="96"
                  alt="web design"
                />
        ...
        <div class="section px-3 px-lg-4 pt-5" id="skills">
          <div class="container-narrow">
            ...
            <div class="text-center">
              <p class="mx-auto mb-3" style="max-width: 600px">
                I am proficient in soft skills, hard skills and programming
                skills needed to deliver valuable results. I have problem
            ...
            <div class="bg-light p-3">
              <div class="row">
                <div class="col-md-5">
                  ...
                  <div class="py-1">
                    <div class="d-flex text-small fw-bolder">
                      <span class="me-auto">CSS3</span><span>80%</span>
                    </div>
                    <div class="progress my-1">
                      <div
                        class="progress-bar bg-primary"
                  ...
                  <div class="py-1">
                    <div class="d-flex text-small fw-bolder">
                      <span class="me-auto">JavaScript</span><span>50%</span>
                    </div>
                    <div class="progress my-1">
                      <div
                        class="progress-bar bg-primary"
                ...
                <div class="col-md-5 offset-md-2">
                  <div class="py-1">
                    <div class="d-flex text-small fw-bolder">
                      <span class="me-auto">PHP</span><span>70%</span>
                    </div>
                    <div class="progress my-1">
                      <div
                        class="progress-bar bg-primary"
                  ...
                  <div class="py-1">
                    <div class="d-flex text-small fw-bolder">
                      <span class="me-auto">Git</span><span>60%</span>
                    </div>
                    <div class="progress my-1">
                      <div
                        class="progress-bar bg-primary"
                  ...
                  <div class="py-1">
                    <div class="d-flex text-small fw-bolder">
                      <span class="me-auto">MySQL</span><span>80%</span>
                    </div>
                    <div class="progress my-1">
                      <div
                        class="progress-bar bg-primary"
              ...
              <div class="col-md-6">
                ...
                >
                    ...
                    <div class="d-flex justify-content-between">
                      <div>
                        ...
                        <div class="text-muted text-small">
                          Google's Developers Student Club (FUTA)
                          <small>(2018 - Date)</small>
                        </div>
                      </div>
                      <img
                  ...
                  <div class="card-body px-3 py-2">
                    <p>
                      I served as a core team member <br />
                      I am currently a frontend development mentor
                    </p>
                  </div>
                </div>
              </div>
              <div class="col-md-6">
                ...
                >
                  <div class="card-header px-3 py-2">
                    <div class="d-flex justify-content-between">
                      <div>
                        <h3 class="h5 mb-1">Backend Development</h3>
                        <div class="text-muted text-small">
                          HNG INternship <small>(2021 - Date)</small>
                        </div>
                      </div>
                      <img
                  ...
                  <div class="card-body px-3 py-2">
                    <p>Currently undergoing training as a backend developer</p>
                  </div>
                </div>
              </div>
              <div class="col-md-6">
                ...
                >
                  <div class="card-header px-3 py-2">
                    <div class="d-flex justify-content-between">
                      <div>
                        <h3 class="h5 mb-1">
                          Full Stack Development, Pen Testing
                        </h3>
                        <div class="text-muted text-small">
                          Livepetal System Limited <small>(2021- Date)</small>
                        </div>
                      </div>
                      <img
                        src="images/services/full-stack.svg"
                  ...
                  <div class="card-body px-3 py-2">
                    <p>
                      Working as an Intern to develop websites that give a
                      seamless and nice experience. I also carry out simple
            ...
            <div class="row">
                ...
                <div class="bg-light my-2 p-3 pt-2">
                  <form action="" method="POST" enctype="multipart/form-data" onsubmit="return validateContactForm()">
                    <div class="form-group my-2">
                      <label for="name" class="form-label fw-bolder">Your Name</label>
                      <span id="userName-info" class="info"></span><br/>
                      <input class="form-control" type="text" id="name" name="name"/>
                    </div>
                    <div class="form-group my-2">
                      <label for="email" class="form-label fw-bolder">Your Email</label>
                    ...
                    <div>
                      <button class="btn btn-primary btn-submit mt-2" name="send" value="send" type="submit">Send</button>
              ...
              <div class="col-md-6" data-aos="fade-left" data-aos-delay="300">
                <div class="mt-3 px-1">
                  ...
                  <p>
                    Or get in touch using my email, LinkedIn or my contact number.
                  </p>
                  <p>See you!</p>
                </div>
                <div class="mt-53 px-1">
                  <div class="row">
                    ...
                    <div class="col-sm-10">
                      <div class="pb-1 fw-bolder">07036044505</div>
                    </div>
                  </div>
                </div>
              </div>
